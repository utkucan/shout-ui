...
public class RefreshableListView extends ListView {
	...
	private void setHeaderHeight(final int height) {
		...
		if (lp == null) {
			lp = new LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		}
		lp.height = height;
		...
		if (headerLp == null) {
			headerLp = new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		}
