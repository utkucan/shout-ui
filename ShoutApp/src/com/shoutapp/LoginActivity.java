...
public class LoginActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPlusClient = new PlusClient.Builder(this, gp_connectionCallback,
				gp_OnConnectionFailedListener).setVisibleActivities(
		...
		((SignInButton) findViewById(R.id.gp_login_btn))
				.setOnClickListener(gp_onClick);
					...
					if (mConnectionResult != null) {
						try {
							mConnectionResult.startResolutionForResult(
									login_activity, REQUEST_CODE_RESOLVE_ERR);
		...
		public void onConnectionFailed(ConnectionResult result) {
			if (mConnectionProgressDialog.isShowing()) {
				if (result.hasResolution()) {
					try {
						result.startResolutionForResult(login_activity,
